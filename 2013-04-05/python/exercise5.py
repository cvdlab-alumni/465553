...
points = [[0,0],[lstep,0.2],[lstep,0.2+hstep],[0,0.2+hstep]];
cells = [[1,2,3,4]];

step = MKPOL([points,cells,None]);
step = PROD([step,Q(2)]);
scale = STRUCT(NN(14)([step,T([1,2])([lstep,hstep])]));




#rotate
scale = MAP([S3,S1,S2])(scale);


#stair1
stair1 = T([1,2,3])([0.5,2.3,-0.2])(scale);




#stair2
stair2 = T([2,3])([-0.75,3.2])(stair1);


#strair3
stair3 = T([2,3])([7.75,3.2])(stair2);

stair=STRUCT([stair3,stair2,stair1])
...
fl14=T([1,2])([-2.3,11])(INSR(PROD)(AA(QUOTE)([[4.8,-10,(2.8+21.25-10-4.8)],[13.8-4-4.8-2.4],[piano]])))
...
stairfaces=STRUCT([faces,stair])


stairfaces=R([1,2])((3*(PI/2)))(stairfaces)
stairfaces=T([2])([13.8])(stairfaces)
