...
var points = [[0,0],[lstep,0.2],[lstep,0.2+hstep],[0,0.2+hstep]];
var cells = [[0,1,3],[1,2,3]];
var step = SIMPLICIAL_COMPLEX(points)(cells);
var step = EXTRUDE([2])(step);
var scalini = STRUCT(REPLICA(14)([step,T([0,1])([lstep,hstep])]));

var scalini = R([1,2])([PI/2])(scalini);
var scalini = R([0,1])([PI/2])(scalini);


var stair1= T([0,1,2])([0.5,2.3,-0.2])(scalini);
var stair2 = T([1,2])([-0.75,3.2])(stair1);
var stair3 = T([1,2])([7.75,3.2])(stair2);

var stair=STRUCT([stair3,stair2,stair1])
...
var stairfaces=STRUCT([faces,stair])
...
var stairfaces = R([0,1])([-PI/2])(stairfaces);
stairfaces=T([1])([13.8])(stairfaces)
