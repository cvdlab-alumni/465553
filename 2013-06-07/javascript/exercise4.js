...
var casa=CUBOID([0.25,0.25,0.25])

var points = [[0,0],[0.25,0.0],[0.25/2,0.25]];
var cells = [[0,1,2]];
var tetto = SIMPLICIAL_COMPLEX(points)(cells);
var tetto = EXTRUDE([0.25])(tetto);

var tetto = R([1,2])([PI/2])(tetto);
tetto=T([0,1,2])([0,0.25,0.25])(tetto)
tetto=COLOR(([255/255,1/255,23/255]))(tetto)
casa=COLOR(([0/255,1/255,5/255]))(casa)
casa1=STRUCT([casa,tetto])
//DRAW(casa1)
/*var casa1,casa2,casa3,casa4,casa5;
//var casa1=T([0,1,2])([6,7,0.2])(casa)
//var casa2=T([0,1,2])([6,8.5,0.3])(casa)
var casa1=T([0,1,2])([8,7.5,0.22])(casa)
var casa2=T([0,1,2])([8.5,7.5,0.25])(casa)
var casa3=T([0,1,2])([8.5,8.5,0.15])(casa)
DRAW(casa1)
DRAW(casa2)
DRAW(casa3)
var casette=STRUCT([casa1,casa2,casa3])
...
for(k=0;k<10;k++){
  for(g=0;g<10;g++){
    ...
    var ap11=mb[k][g]
    if((ap>3.6) && (ap<=4)){
      DRAW(TRANSLATE([0,1,2])([k,g,ap11-0.5])(casa1))
//      casette=STRUCT([casapp,casette])
